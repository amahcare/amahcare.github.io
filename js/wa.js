$(document).ready(function() {
	$('#WABoton').floatingWhatsApp({
		...
		avatarName: 'Amah Care', // Nombre del avatar
		avatarRole: 'Equipo de soporte', // Rol del avatar
    ...
    b.fn.floatingWhatsApp=function(r) {
        ...
        e.addClass("floating-wpp-button").append(b(j.buttonImage)).css( {
            width: j.size, height: j.size, "background-color": j.backgroundColor
        }
        );
        if(!c()||j.showOnIE) {
